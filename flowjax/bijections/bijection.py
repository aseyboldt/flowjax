...
class AbstractBijection(eqx.Module):
    ...
    def inverse_gradient_and_val_(
        ...
        return AbstractBijection.inverse_gradient_and_val(self, y, y_grad, y_logp, condition)
        #return self.inverse_gradient_and_val(y, y_grad, y_logp, condition)
